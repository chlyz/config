...
let g:colors_name="Tokyo Vivendi"
...
let s:green             = "#44bc44"
let s:green_alt         = "#70b900"
let s:green_alt_other   = "#00c06f"
let s:yellow            = "#d0bc00"
let s:yellow_alt        = "#c0c530"
let s:yellow_alt_other  = "#d3b55f"
...
let s:cyan              = "#00d3d0"
let s:cyan_alt          = "#4ae2f0"
let s:cyan_alt_other    = "#6ae4b9"
let s:cyan_faint        = "#90c4ed"
let s:cyan_alt_faint    = "#a0bfdf"
let s:cyan_alt_other_faint = "#a4d0bb"
...
let s:fg_docstring    = "#b0d6f5"

let s:fg_comment_yellow = "#d0a070"
...
call <SID>highlight("Comment",      "None",               s:fg_alt,             "italic")
call <SID>highlight("Conditional",  "None",               s:magenta_alt,        "None")
...
call <SID>highlight("Function",     "None",               s:blue_alt,           "None")
...
call <SID>highlight("String",       "None",               s:yellow_alt,  "None")
call <SID>highlight("Structure",    "None",               "None",               "None")
call <SID>highlight("Tag",          "None",               "None",               "None")
call <SID>highlight("Todo",         "None",               s:fg_lang_warning,    "italic")
call <SID>highlight("Type",         "None",               s:cyan,               "italic")
call <SID>highlight("Typedef",      "None",               "None",               "italic")
...
call <SID>highlight("TSConstant",        "None", s:orange_intense,    "None")
call <SID>highlight("TSConstMacro",      "None", s:blue_alt_other,    "None")
call <SID>highlight("TSConstBuiltin",    "None", s:cyan,              "None")
call <SID>highlight("TSOperator",        "None", s:blue_alt_other,    "None")
call <SID>highlight("TSFunction",        "None", s:blue_alt,          "None")
call <SID>highlight("TSFuncMacro",       "None", s:blue_alt_other,    "None")
call <SID>highlight("TSLabel",           "None", s:blue_alt,          "None")
call <SID>highlight("TSStringEscape",    "None", s:magenta_alt_other, "None")
call <SID>highlight("TSException",       "None", s:magenta_alt,       "None")
call <SID>highlight("TSRepeat",          "None", s:magenta_alt,       "None")

call <SID>highlight("TSKeyword",         "None", s:magenta_alt_other, "italic")
call <SID>highlight("TSKeywordReturn",   "None", s:magenta_alt_other, "italic")
call <SID>highlight("TSKeywordFunction", "None", s:magenta_alt,       "None")
call <SID>highlight("TSKeywordOperator", "None", s:blue_alt_other,    "None")

call <SID>highlight("TSInclude",         "None", s:blue_alt_other,    "None")
call <SID>highlight("TSNumber",          "None", s:orange_intense,    "None")
call <SID>highlight("TSBoolean",         "None", s:orange_intense,    "None")
call <SID>highlight("TSPunctBracket",    "None", s:fg_main,           "None")
call <SID>highlight("TSPunctDelimiter",  "None", s:blue_alt_other,    "None")

call <SID>highlight("TSWarning",         "None", s:fg_lang_warning,   "bold,italic")
call <SID>highlight("TSDanger",          "None", s:fg_lang_error,     "None")
call <SID>highlight("TSNote",            "None", s:fg_lang_note,      "None")

call <SID>highlight("TSType",            "None", s:cyan_alt,          "None")
call <SID>highlight("TSTypeBuiltin",     "None", s:cyan_alt,          "None")
call <SID>highlight("TSNamespace",       "None", s:blue_alt_other,    "None")
call <SID>highlight("TSParameter",       "None", s:yellow_alt_other,  "None")
call <SID>highlight("TSVariable",        "None", "None",              "None")
call <SID>highlight("TSVariableBuiltin", "None", s:cyan,              "None")
call <SID>highlight("TSField",           "None", s:cyan_alt_other,    "None")
call <SID>highlight("TSProperty",        "None", s:cyan_alt_other,    "None")
